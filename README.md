...
> 로컬 실행 화면이며, 속삭임 내용은 예시 데이터입니다.

### 본 서비스

<img src="docs/images/service-home.png" width="100%" alt="속삭임 목록"/>

지역과 **그날의 날씨가 글에 함께 남습니다.** 목록은 최신순이고, 각 글에는
공감 · 응원 · 토닥 세 가지 반응을 남길 수 있습니다.

#### 속삭임 작성

<img src="docs/images/service-write.png" width="100%" alt="속삭임 작성"/>

지역을 고르고 최대 500자까지 익명으로 남깁니다. 작성 시점의 날씨를 조회해
글과 함께 저장하므로, 나중에 봐도 그때의 날씨가 그대로 남아 있습니다.

#### 신고

<img src="docs/images/service-report.png" width="100%" alt="신고"/>

사유를 골라 신고합니다. 자기 글은 신고할 수 없고, 한 사람이 같은 글을
여러 번 신고할 수 없습니다.

#### 신고 누적 시 임시 숨김

<img src="docs/images/service-hidden.png" width="100%" alt="임시 숨김된 글"/>

서로 다른 사용자 3명이 신고하면 다른 사람에게 보이지 않습니다.
**영구 삭제가 아니라 30일 임시조치**이며, 작성자 본인에게는 위와 같이
해제 예정일이 안내됩니다.

#### 모바일

<img src="docs/images/service-mobile.png" width="320" alt="모바일 화면"/>

### 랜딩페이지

|                                  메인                                  |                                  입장하기 모달                                   |
| :--------------------------------------------------------------------: | :------------------------------------------------------------------------------: |
| <img src="docs/images/landing-home.png" width="100%" alt="랜딩 메인"/> | <img src="docs/images/landing-modal.png" width="100%" alt="랜딩 입장하기 모달"/> |
